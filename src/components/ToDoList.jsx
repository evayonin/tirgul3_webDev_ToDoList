...
function TodoList(){
    ...
    const deleteTask =()=>{
        ...
        // עדכון המערך כך שישמור את המערך המקורי בלי האיבר (המשימה) עם האינדקס השמור שבאנו למחוק, בסטייט של אינדקס
        setIndex(null)
                        ...
                        { // עכשיו נגדיר מה יהיה בתוך הרשימה ul:
                            tasks.map((task, index) => // מפה שרצה על כל משימה (סוג האיבר) במערך המשימות לפי הסדר במערך, ובהתאמה לאינדקסים (בשביל מספור)
                                ...
                                <li
                                    ...
                                    <button onClick={deleteTask}>Delete</button>   {/*כפתור מחיקה לפי פונקציה מתאימה*/}
                                </li>
                            )
                        }
                    </ul>
